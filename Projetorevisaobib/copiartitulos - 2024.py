...
res = requests.get('https://repositorio.ufpe.br/handle/123456789/25413/simple-search?location=123456789%2F25413&query=&filter_field_1=dateIssued&filter_type_1=equals&filter_value_1=2024&rpp=40&sort_by=dc.date.issued_dt&order=DESC&etal=0&submit_search=Atualizar')
...
df.to_excel('dissertacoes_2024.xlsx', index=False)
print(f"Pronto! {len(df)} dissertações foram salvas na planilha 'dissertacoes_2024.xlsx'.")